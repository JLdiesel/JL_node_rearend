...
class FileService {
  async createAvatar(filename, mimetype, size, userId) {
    ...
    return result[0];} catch (err) {
                                  return err
                                }
  }
  async createVideoAvatar(filename, mimetype, size, videoId) {try{
  ...
  async createVideo(filename, mimetype, size, videoId) {try{
  ...
  async getAvatarByUserId(userId) {try{
    const statement = `SELECT * FROM avatar WHERE user_id=?`;
    const [result] = await connection.execute(statement, [userId]);
    return result.pop();} catch (err) {
                                  return err
                                }
  }
  async getAvatarByVideoId(videoId) {try{
  ...
  async getVideoByVideoId(videoId) {try{
  ...
  async createFile(filename, mimetype, size, momentId) {try{
  ...
  async createShopBannerFile(filename, mimetype, size, shopId) {try{
  ...
  async createShopInnerFile(filename, mimetype, size, shopId) {try{
  ...
  async createShopcar(filename, mimetype, size, shopId) {try{
  ...
  async createApply(filename, mimetype, size, applyId) {try{
  ...
  async getBannerByFilename(filename) {try{
  ...
  async getInnerByFilename(filename) {try{
