...
where id=?`;
  ...
  async updateAvatarUrlById(avatarUrl, userId) {try{
  ...
  async updateBackgroundById(avatarUrl, userId) {try{
  ...
  async updateUserInfo(id, nickName, sex, birthday, ownSay) {try{
...
ON DUPLICATE KEY UPDATE nickName=VALUES(nickName), sex=VALUES(sex), birthday=VALUES(birthday), ownSay=VALUES(ownSay); `;
  ...
  async removeFollow(insertId, userId) {try{
  ...
  async createFollow(insertId, userId) {try{
...
WHERE f.user_id=? and status = 0
  ...
  async updateUserStatus(userId) {try{
  ...
  //获取用户地址
  async getUserAddress(userId) {try{
...
`;
  ...
  async addAddress(userId, name, phoneNum, address) {try{
...
`;
  ...
  async removeAddress(addressId) {try{
  ...
  async addOrider(shopId, shopCarId, insertId, addressId, count, howPay) {try{
  ...
  async getOriderByOriderId(oriderId) {try{
...
`;
  ...
  async getOriderListByUserId(userId, offset, top) {try{
...
`;
  ...
  async getOriderListByStatus(userId, status) {try{
...
`;
  ...
  async changeOriderListStatus(oriderId, status) {try{
  ...
  async removeOriderListById(oriderId) {try{
  ...
  async clearDefaultAddress(userId) {try{
  ...
  async changeUserDefaultAddress(addressId) {try{
  ...
  async findDefaultAddress(userId) {try{
  ...
  async createApply(realName, idCard, id) {try{
